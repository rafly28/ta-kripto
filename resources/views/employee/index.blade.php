                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y">
                            @forelse($employees as $employee)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-sm space-x-2">
                                        ...
                                        <form action="{{ route('employee.destroy', $employee) }}" method="POST" class="inline" onsubmit="return confirm('Delete this employee?')">
                                            @csrf @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-3 text-center text-gray-500">No employees yet</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
